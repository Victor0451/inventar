...
import LogisticSection from "/pages-sections/LandingPage-Sections/LogisticSection.js";
  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax filter responsive image="/img/logisticbg.webp">
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>Nuestro Servicio de logistica.</h1>
              <h4>
